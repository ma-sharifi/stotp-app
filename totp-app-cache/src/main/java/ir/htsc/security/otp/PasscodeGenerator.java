...
public class PasscodeGenerator {
   ...
   * prevents invalid STOTP generation when Math.pow() is implemented incorrectly
  ...
  /**
   * @param state 8-byte integer value representing internal STOTP state.
    ...
    if (challenge == null) {
      ...
      byte[] value =
          ByteBuffer.allocate(8 + challenge.length)
              .putLong(state) // Write out STOTP state
...
////        byte[] key = Base64.decodeBase64("06BAEnk8SyuHvQAkEh/cN4eMS/4Zh9R3kQzuUTIvsfs=");
//    byte[] key = Base64.getDecoder().decode("06BAEnk8SyuHvQAkEh/cN4eMS/4Zh9R3kQzuUTIvsfs=");
//    //otpId = 3
//    //otpToken = 13f6evuogu3fdgscrb7dn7k1v2
//    MacGenerator macGenerator = new MacGenerator(key);
//    PasscodeGenerator passcodeGenerator = new PasscodeGenerator(macGenerator);
//    long seq = (System.currentTimeMillis() / 1000) / 30;
//    String passCode = passcodeGenerator.generateResponseCode(seq);
//    System.out.println(seq + "   " + passCode);
//    System.out.println(passCode);
//    String passCode1 = passcodeGenerator.generateResponseCode(31);
//    String passCode2 = passcodeGenerator.generateResponseCode(32);
//    String passCode3 = passcodeGenerator.generateResponseCode(33);
//    String passCode_1 = passcodeGenerator.generateResponseCode(29);
//    String passCode_2 = passcodeGenerator.generateResponseCode(28);
//    String passCode_3 = passcodeGenerator.generateResponseCode(27);
//
//    System.out.println(passcodeGenerator.verifyResponseCode(30, passCode));
//    System.out.println("--------------------------------");
//    System.out.println(passcodeGenerator.verifyTimeoutCode(30, passCode_3));
//    System.out.println(passcodeGenerator.verifyTimeoutCode(30, passCode_2));
//    System.out.println(passcodeGenerator.verifyTimeoutCode(30, passCode_1));
//    System.out.println(passcodeGenerator.verifyTimeoutCode(30, passCode1));
//    System.out.println(passcodeGenerator.verifyTimeoutCode(30, passCode2));
//    System.out.println(passcodeGenerator.verifyTimeoutCode(30, passCode3));
//  }
}
